...
//        => optionsBuilder.UseSqlServer("Server=DESKTOP-VI57TV8\\HWJHONATAN;Database=Inventario;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CompraId).HasName("PK__Compras__067DA7457510B78E");
        ...
        {
            entity.HasKey(e => e.ProductoId).HasName("PK__Producto__A430AEA3E520F67C");
        ...
        {
            entity.HasKey(e => e.ProveedorId).HasName("PK__Proveedo__61266A59D9D5E08F");
        ...
        {
            entity.HasKey(e => e.RolId).HasName("PK__Roles__F92302F1DF05BEF1");
        ...
        {
            entity.HasKey(e => e.UsuarioId).HasName("PK__Usuarios__2B3DE7B8127A3A86");
        ...
        {
            entity.HasKey(e => e.VentaId).HasName("PK__Ventas__5B4150AC6814AF1B");
